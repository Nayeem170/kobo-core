...
///
/// The hwtcon enum maps 4 = GLR16/REAGL and 6 = A2, unlike the NXP mxcfb
/// numbering the constants above follow -- so on MTK hardware [`WAVE_A2`]
/// has in fact been driving REAGL. REAGL is the "full-quality, flash-free"
/// waveform: paired with a FULL update it re-drives every pixel and applies
/// regal ghost-suppression, clearing residue that GL16 leaves behind,
/// without GC16's dark inversion blink. Use it for whole-screen interactive
/// transitions on MTK devices.
pub const WAVE_REAGL_MTK: u32 = 4;
